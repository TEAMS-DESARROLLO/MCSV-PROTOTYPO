...
public class SectorPaginationService implements IPaginationCommons<SectorDTO> {

       
    private final  EntityManager entityManager;

    @Override
    public Page<SectorDTO> pagination(PaginationModel pagination) {
        ...
        try {
            ...
            Page<SectorDTO> page = new PageImpl<SectorDTO>(lista, pageable, total);
    ...
    public StringBuilder getSelect() {
        StringBuilder sql = new StringBuilder("SELECT new com.bussinesdomain.maestros.dto.SectorDTO(a.idSector,a.descripcion,a.estado) ");
        return sql;
    }
